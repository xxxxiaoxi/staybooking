...
public class StayService {
    ...
    @Autowired
    public StayService(StayRepository stayRepository, LocationRepository locationRepository, ImageStorageService imageStorageService, GeoCodingService geoCodingService, ReservationRepository reservationRepository, StayReservationDateRepository stayReservationDateRepository) {
    ...
    //if method throw exception, then rollback to original status  相当于try catch
    @Transactional(isolation = Isolation.SERIALIZABLE)
